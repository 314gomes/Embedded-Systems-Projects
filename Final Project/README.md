...
1. Preparar dois firmwares:
   - [Firmware A (antes da atualização)](<Final Project/No blink/src/main.cpp>): implementa o servidor web para OTA e gerencia as requisições na função `loop` principal.
